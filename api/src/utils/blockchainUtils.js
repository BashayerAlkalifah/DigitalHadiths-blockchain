...
const registerUser = async (orgName, userName, registrationType) => {
  ...
  secret = await ca.register(
    {
      ...
      role: 'client',
      attrs: [
        { name: 'registrationType', value: registrationType, ecert: true },
        { name: 'role', value: 'approver', ecert: true },
      ],
    },
    adminUser
  );
  // const secret = await ca.register({ affiliation: 'org1.registrationType1', enrollmentID: userName, role: 'client', attrs: [{ name: 'role', value: 'approver', ecert: true }] }, adminUser);
  ...
  const enrollment = await ca.enroll({
    ...
    attr_reqs: [
      ...
      { name: 'registrationType', optional: false },
    ],
  });
