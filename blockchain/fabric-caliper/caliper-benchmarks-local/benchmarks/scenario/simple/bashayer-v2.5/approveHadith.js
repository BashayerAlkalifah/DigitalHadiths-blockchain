...
class ApproveAndRejectHadithWorkload extends WorkloadModuleBase {
    ...
    async submitTransaction() {
        try {
            ...
            const hadithStatusBuffer = await this.sutAdapter.sendRequests({
                ...
                contractFunction: 'validateApprovals',
                contractArguments: [hadithId, JSON.stringify(user)],
                readOnly: true
            });
            ...
            await this.sutAdapter.sendRequests({
                contractId: 'HadithChain',
                contractFunction: 'approveHadith',
...
function createWorkloadModule() {
    return new ApproveAndRejectHadithWorkload();
}
